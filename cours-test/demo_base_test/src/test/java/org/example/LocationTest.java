...
public class LocationTest {
    ...
    @Test
    void rentDueInDecreaseEveryDailyRoutine ()throws ConditionException{
    ...
    @Test
    void conditionDecreaseEveryDailyRoutine ()throws ConditionException{
        voiture = Voiture.builder().rentDueIn(5).condition(5).type("classic").build();
    ...
    @Test
    void afterDueDateConditionDecrease2Time ()throws ConditionException{
    ...
    @Test
    void conditionVoitureLuxeIncrease ()throws ConditionException{
    ...
    @Test
    void conditionDecrease2TimeFasterForOldVoiture ()throws ConditionException{
    ...
    @Test
    void conditionDecrease2TimeFasterForOldVoitureForDueDate0 ()throws ConditionException{
